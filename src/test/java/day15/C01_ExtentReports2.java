...
public class C01_ExtentReports2 extends TestBase {
    ...
    @BeforeClass
    public static void extentReporsSetUp() {
        //REPORT  PATH
...
//        Extent Test objesi ni olustur
    ...
    @Test
    public void exentReportsSetUp() {
        extentTest.pass("PASS");
        extentTest.info("Bilgilendirme");
        extentTest.fail("failed");
//        extentTest.warning("uyari mesaji");
//        extentTest.skip("Atlama mesaji");
//        extentTest.fatal("cöküs hatasi");

    }

    @AfterClass
    public static void exentReportsTearDown() throws Exception {
        extentReports.flush();
